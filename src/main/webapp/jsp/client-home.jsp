		...
		<div align="center" id="tabs-1">
			...
			<form action="customer-home" class="clientformayuda" method="POST">
				<button type="submit" name="submit-btn" id="envio"
					value="request-visit">Solicitar visita</button>
			</form>
		</div>
					...
					<div id="viewTableAs">
						<ol>
							...
							<c:forEach var="visit" items="${visits}">
								<c:set var="idvisit" value="afirma${idvisit+1}" />
								<li><c:out value="${idvisit}" />
									<div id="dialogo" title="Basic dialog">
										<p>
											...
											value="${visits.isReady() ? 'Realizada': 'Por realizar'}" /></td>
									...
									<tr>
										...
										<td class="sinborde">
											<form action="home" method="POST">
												...
												<br> <input type="hidden" name="hidden-id"
													value="${pay.getId()}">
											</form>
										</td>
									</tr>
